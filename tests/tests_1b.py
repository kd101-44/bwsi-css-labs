...
def test_addition():
    ...
    assert simple_calculator("add", -1, -2) == -3        # Test for negative and negative number 
def test_subtraction():
    ...
    assert simple_calculator("subtract", 1, -2) == 3   # Test for positive and negative numbers 
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", 0, 100) == 0   # Test for negative and negative numbers
...
def test_division():
    ...
    assert simple_calculator("divide", -2, -2) == 1     # Test for negative number division
